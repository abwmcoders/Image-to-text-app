...
import 'package:ocr/screens/recognization_page.dart';
import 'package:ocr/utils/image_cropper_view.dart';
                ...
                (value) {
                  if (value != '') {
                    imageCropperView(value, context).then((value) {
                      if(value != '') {
                         Navigator.push(
        context, CupertinoPageRoute(builder: (_) => RecognizationPage(
          path: value,
        )));
                      }
                    });
